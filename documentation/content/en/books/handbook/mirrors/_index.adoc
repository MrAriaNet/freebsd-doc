...
| ftp.ir.FreeBSD.org
| link:http://ftp.ir.FreeBSD.org/FreeBSD[http] link:http://ftp.ir.FreeBSD.org/FreeBSD[http_v6] link:ftp://ftp.ir.FreeBSD.org/FreeBSD[ftp] link:ftp://ftp.ir.FreeBSD.org/FreeBSD[ftp_v6]  link:rsync://ftp.ir.FreeBSD.org[rsync]
